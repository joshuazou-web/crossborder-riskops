...
![调查工作台二十秒:案件摘要、把它排到第一位的八个因子,以及证据与反证的并排布局
](docs/screenshots/demo-zh.gif)

*一个案件,三条相互独立的风险模式,以及把它排到队列第一位的八个因子——全部摊开,
所以不认同排序的人能看到是哪一项造成的。然后是证据,以及**并排而不是在它下面**的反证。
这个位置就是设计本身:被队列压着的复核人自上而下读,而且会提前停。*

**[▶ 完整演示 · 2 分 02 秒 · 中文界面,中文配音与字幕](docs/demo/demo-zh-narrated.mp4)** —— 从四万笔转账,到一个团队真正打得开的两百四十二个案件;工作台给调查员看什么,以及这个产品拒绝做什么。
